...
public class App
{
    public static void extraireRegleAssociation(BufferedReader out) throws IOException{
        ...
        List<Motif> lignes;
        try(PrintWriter sortie = new PrintWriter(new BufferedWriter(new FileWriter("regleAssociation.csv")))){
    ...
    {
        try(BufferedReader buff = new BufferedReader(new FileReader("out.trans"))) {
